...
import { Row, Col, Image, Form, Input, Button, BackTop } from "antd";
  ...
  return (
    <Row>
      <Col span={12} offset={6}>
        ...
        <div className="pdf-box" id="pdf">
          <div className="tittle">PDF</div>
          <Row>
            <Col span={6}></Col>
            <Col span={6}>
              <Image
            ...
            <Col span={6}>
              ...
              <Image
                ...
                fallback="data:image/png;base64,"
              />
              <p className="titke">English</p>
            </Col>
            <Col span={6}></Col>
          </Row>
        </div>
        <div className="pdf-box" id="registro">
          <div className="tittle">REGISTRO</div>
          <div className="box-registro">
            <Form form={form} layout="vertical">
              <Form.Item label="COLLECTOR" tooltip="COLLECTOR">
                <Input
        ...
        <div className="pdf-box" id="inversion">
          <div className="tittle">INVERSIÓN</div>
          <div className="box-inversion">
            <Form form={form} layout="vertical">
              <Row>
                <Col span={12}>
                  <Form.Item label="COLLECTOR" tooltip="COLLECTOR">
        ...
        <div className="pdf-box" id="telegram">
          <div className="tittle">TELEGRAM</div>
          <Image
            width={80}
            height="auto"
            src={telegram}
